package cn.qmsk.intermediary.module.iot.core.messagebus.config;

import cn.qmsk.intermediary.framework.mq.redis.core.RedisMQTemplate;
import cn.qmsk.intermediary.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.qmsk.intermediary.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.qmsk.intermediary.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.qmsk.intermediary.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.qmsk.intermediary.module.iot.core.messagebus.core.IotMessageBus;
import cn.qmsk.intermediary.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.qmsk.intermediary.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.qmsk.intermediary.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "intermediary.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "intermediary.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 IntermediaryRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.qmsk.intermediary.framework.mq.redis.config.IntermediaryRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "intermediary.iot.message-bus", name = "type", havingValue = "redis")
