package cn.qmsk.intermediary.module.iot.api.device;
...
import cn.qmsk.intermediary.module.iot.core.biz.dto.*;
...
import cn.qmsk.intermediary.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 intermediary-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
