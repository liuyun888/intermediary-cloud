package cn.qmsk.intermediary.module.iot.job.device;
...
import cn.qmsk.intermediary.module.iot.framework.iot.config.IntermediaryIotProperties;
...
public class IotDeviceOfflineCheckJob {
    ...
    @Resource
    private IntermediaryIotProperties iotProperties;
