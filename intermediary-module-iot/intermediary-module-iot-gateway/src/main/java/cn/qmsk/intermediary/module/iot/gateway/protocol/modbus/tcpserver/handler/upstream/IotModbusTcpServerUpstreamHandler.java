package cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.qmsk.intermediary.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import cn.qmsk.intermediary.module.iot.core.biz.IotDeviceCommonApi;
import cn.qmsk.intermediary.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.qmsk.intermediary.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.qmsk.intermediary.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.qmsk.intermediary.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.qmsk.intermediary.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.qmsk.intermediary.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.qmsk.intermediary.module.iot.core.mq.message.IotDeviceMessage;
import cn.qmsk.intermediary.module.iot.core.topic.IotDeviceIdentity;
import cn.qmsk.intermediary.module.iot.core.util.IotDeviceAuthUtils;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.qmsk.intermediary.module.iot.gateway.service.device.IotDeviceService;
import cn.qmsk.intermediary.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.qmsk.intermediary.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.qmsk.intermediary.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.qmsk.intermediary.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.qmsk.intermediary.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
