package cn.qmsk.intermediary.module.iot.gateway.config;

import cn.qmsk.intermediary.module.iot.core.enums.IotProtocolTypeEnum;
import cn.qmsk.intermediary.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.qmsk.intermediary.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
import lombok.Data;
...
@ConfigurationProperties(prefix = "intermediary.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.qmsk.intermediary.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.qmsk.intermediary.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
