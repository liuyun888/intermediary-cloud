package cn.qmsk.intermediary.module.ai.service.chat;
...
import cn.qmsk.intermediary.framework.tenant.core.util.TenantUtils;
import cn.qmsk.intermediary.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.qmsk.intermediary.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.qmsk.intermediary.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.qmsk.intermediary.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.qmsk.intermediary.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.qmsk.intermediary.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.qmsk.intermediary.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.qmsk.intermediary.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.qmsk.intermediary.module.ai.dal.dataobject.model.AiModelDO;
import cn.qmsk.intermediary.module.ai.dal.dataobject.model.AiToolDO;
import cn.qmsk.intermediary.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.qmsk.intermediary.module.ai.enums.ErrorCodeConstants;
import cn.qmsk.intermediary.module.ai.enums.model.AiPlatformEnum;
import cn.qmsk.intermediary.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.qmsk.intermediary.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.qmsk.intermediary.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.qmsk.intermediary.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.qmsk.intermediary.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.qmsk.intermediary.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.qmsk.intermediary.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.qmsk.intermediary.module.ai.service.model.AiChatRoleService;
import cn.qmsk.intermediary.module.ai.service.model.AiModelService;
import cn.qmsk.intermediary.module.ai.service.model.AiToolService;
import cn.qmsk.intermediary.module.ai.util.AiUtils;
import cn.qmsk.intermediary.module.ai.util.FileTypeUtils;
...
import static cn.qmsk.intermediary.framework.common.pojo.CommonResult.error;
import static cn.qmsk.intermediary.framework.common.pojo.CommonResult.success;
import static cn.qmsk.intermediary.framework.common.util.collection.CollectionUtils.convertList;
import static cn.qmsk.intermediary.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.qmsk.intermediary.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.qmsk.intermediary.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 intermediary.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 intermediary.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
