package cn.qmsk.intermediary.module.ai.framework.ai.core.model;
...
import cn.qmsk.intermediary.framework.common.util.spring.SpringUtils;
import cn.qmsk.intermediary.module.ai.enums.model.AiPlatformEnum;
import cn.qmsk.intermediary.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.qmsk.intermediary.module.ai.framework.ai.config.IntermediaryAiProperties;
...
import cn.qmsk.intermediary.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.qmsk.intermediary.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            IntermediaryAiProperties.Midjourney properties = SpringUtil.getBean(IntermediaryAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(IntermediaryAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        IntermediaryAiProperties.DouBao properties = new IntermediaryAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(IntermediaryAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        IntermediaryAiProperties.HunYuan properties = new IntermediaryAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(IntermediaryAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        IntermediaryAiProperties.SiliconFlow properties = new IntermediaryAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(IntermediaryAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        IntermediaryAiProperties.XingHuo properties = new IntermediaryAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(IntermediaryAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        IntermediaryAiProperties.BaiChuan properties = new IntermediaryAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(IntermediaryAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        IntermediaryAiProperties.Gemini properties = SpringUtil.getBean(IntermediaryAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        IntermediaryAiProperties.Grok properties = new IntermediaryAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
