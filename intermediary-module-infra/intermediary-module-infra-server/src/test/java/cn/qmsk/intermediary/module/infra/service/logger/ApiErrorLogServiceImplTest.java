package cn.qmsk.intermediary.module.infra.service.logger;
...
import cn.qmsk.intermediary.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.qmsk.intermediary.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.qmsk.intermediary.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.qmsk.intermediary.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.qmsk.intermediary.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.qmsk.intermediary.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("intermediary-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("intermediary-test");
