...
import cn.qmsk.intermediary.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "intermediary.tracer", value = "enable", matchIfMissing = true)
public class IntermediaryTracerAutoConfiguration {
