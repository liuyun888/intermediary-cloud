package cn.qmsk.intermediary.framework.jackson.config;

import cn.qmsk.intermediary.framework.common.util.json.JsonUtils;
import cn.qmsk.intermediary.framework.common.util.json.databind.NumberSerializer;
import cn.qmsk.intermediary.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.qmsk.intermediary.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class IntermediaryJacksonAutoConfiguration {
