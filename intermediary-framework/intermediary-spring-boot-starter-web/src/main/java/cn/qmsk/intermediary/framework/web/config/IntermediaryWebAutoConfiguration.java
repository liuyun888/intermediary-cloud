package cn.qmsk.intermediary.framework.web.config;
...
import cn.qmsk.intermediary.framework.web.core.filter.CacheRequestBodyFilter;
import cn.qmsk.intermediary.framework.web.core.filter.DemoFilter;
import cn.qmsk.intermediary.framework.web.core.handler.GlobalExceptionHandler;
import cn.qmsk.intermediary.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class IntermediaryWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "intermediary.demo", havingValue = "true")
