package cn.qmsk.intermediary.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.qmsk.intermediary.framework.common.util.json.JsonUtils;
import cn.qmsk.intermediary.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${intermediary.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class IntermediaryMybatisAutoConfiguration {
