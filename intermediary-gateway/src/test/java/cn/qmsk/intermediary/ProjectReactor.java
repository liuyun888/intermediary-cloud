...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.qmsk.insurance";
    private static final String ARTIFACT_ID = "intermediary";
    private static final String PACKAGE_NAME = "cn.qmsk.intermediary";
    private static final String TITLE = "保险中介系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.qmsk.insurance";
        String artifactIdNew = "intermediary";
        String packageNameNew = "cn.qmsk.intermediary";
        String titleNew = "保险中介系统";
        String projectBaseDirNew = "/Users/liuyunkai/Documents/workspace/保险中介/intermediary"; // 一键改名后，“新”项目所在的目录
