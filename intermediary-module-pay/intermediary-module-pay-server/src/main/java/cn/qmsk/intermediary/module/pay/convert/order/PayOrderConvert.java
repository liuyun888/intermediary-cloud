package cn.qmsk.intermediary.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.qmsk.intermediary.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
