...
import cn.qmsk.intermediary.framework.common.util.string.StrUtils;
import cn.qmsk.intermediary.framework.dict.core.DictFrameworkUtils;
import cn.qmsk.intermediary.framework.ip.core.utils.AreaUtils;
import cn.qmsk.intermediary.module.member.api.address.dto.MemberAddressRespDTO;
import cn.qmsk.intermediary.module.member.api.user.dto.MemberUserRespDTO;
...
import cn.qmsk.intermediary.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
...
import cn.qmsk.intermediary.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.qmsk.intermediary.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.qmsk.intermediary.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.qmsk.intermediary.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.qmsk.intermediary.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.qmsk.intermediary.module.trade.controller.admin.order.vo.*;
import cn.qmsk.intermediary.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.qmsk.intermediary.module.trade.controller.app.order.vo.*;
import cn.qmsk.intermediary.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.qmsk.intermediary.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.qmsk.intermediary.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.qmsk.intermediary.module.trade.framework.order.config.TradeOrderProperties;
import cn.qmsk.intermediary.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.qmsk.intermediary.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.qmsk.intermediary.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.qmsk.intermediary.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/intermediarycode/intermediary-mall-uniapp/issues/ICY7SJ
