package cn.qmsk.intermediary.module.trade.controller.admin.config;

import cn.qmsk.intermediary.framework.common.pojo.CommonResult;
import cn.qmsk.intermediary.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import cn.qmsk.intermediary.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import cn.qmsk.intermediary.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${intermediary.tencent-lbs-key}")
