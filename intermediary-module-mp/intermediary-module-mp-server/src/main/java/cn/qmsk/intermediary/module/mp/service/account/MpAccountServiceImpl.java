package cn.qmsk.intermediary.module.mp.service.account;
...
import cn.qmsk.intermediary.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.qmsk.intermediary.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.qmsk.intermediary.module.mp.convert.account.MpAccountConvert;
import cn.qmsk.intermediary.module.mp.dal.dataobject.account.MpAccountDO;
import cn.qmsk.intermediary.module.mp.dal.mysql.account.MpAccountMapper;
import cn.qmsk.intermediary.module.mp.enums.ErrorCodeConstants;
...
import static cn.qmsk.intermediary.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 intermediary-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
