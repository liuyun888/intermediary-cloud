package cn.qmsk.intermediary.module.bpm.service.task;
...
import cn.qmsk.intermediary.framework.common.util.date.DateUtils;
import cn.qmsk.intermediary.framework.common.util.json.JsonUtils;
import cn.qmsk.intermediary.framework.common.util.object.ObjectUtils;
import cn.qmsk.intermediary.framework.common.util.object.PageUtils;
import cn.qmsk.intermediary.framework.datapermission.core.annotation.DataPermission;
import cn.qmsk.intermediary.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.qmsk.intermediary.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.qmsk.intermediary.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.qmsk.intermediary.module.bpm.controller.admin.task.vo.instance.*;
import cn.qmsk.intermediary.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.qmsk.intermediary.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.qmsk.intermediary.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.qmsk.intermediary.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.qmsk.intermediary.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.qmsk.intermediary.module.bpm.enums.ErrorCodeConstants;
import cn.qmsk.intermediary.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.qmsk.intermediary.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.qmsk.intermediary.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.qmsk.intermediary.module.bpm.enums.task.BpmReasonEnum;
import cn.qmsk.intermediary.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.qmsk.intermediary.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.qmsk.intermediary.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.qmsk.intermediary.module.bpm.service.message.BpmMessageService;
import cn.qmsk.intermediary.module.system.api.dept.DeptApi;
import cn.qmsk.intermediary.module.system.api.dept.dto.DeptRespDTO;
...
import static cn.qmsk.intermediary.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.qmsk.intermediary.module.bpm.enums.ErrorCodeConstants.*;
import static cn.qmsk.intermediary.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.qmsk.intermediary.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/intermediary-cloud/issues/ID1UYA
