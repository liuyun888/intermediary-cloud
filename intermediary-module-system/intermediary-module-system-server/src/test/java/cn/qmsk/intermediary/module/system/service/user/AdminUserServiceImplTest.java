package cn.qmsk.intermediary.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.qmsk.intermediary.framework.common.enums.CommonStatusEnum;
import cn.qmsk.intermediary.framework.common.exception.ServiceException;
import cn.qmsk.intermediary.framework.common.pojo.PageResult;
import cn.qmsk.intermediary.framework.common.util.collection.ArrayUtils;
import cn.qmsk.intermediary.framework.common.util.collection.CollectionUtils;
import cn.qmsk.intermediary.framework.test.core.ut.BaseDbUnitTest;
import cn.qmsk.intermediary.module.infra.api.config.ConfigApi;
import cn.qmsk.intermediary.module.infra.api.file.FileApi;
import cn.qmsk.intermediary.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.qmsk.intermediary.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.qmsk.intermediary.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.qmsk.intermediary.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.qmsk.intermediary.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.qmsk.intermediary.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import cn.qmsk.intermediary.module.system.dal.dataobject.dept.UserPostDO;
import cn.qmsk.intermediary.module.system.dal.dataobject.tenant.TenantDO;
import cn.qmsk.intermediary.module.system.dal.dataobject.user.AdminUserDO;
import cn.qmsk.intermediary.module.system.dal.mysql.dept.UserPostMapper;
import cn.qmsk.intermediary.module.system.dal.mysql.user.AdminUserMapper;
import cn.qmsk.intermediary.module.system.enums.common.SexEnum;
import cn.qmsk.intermediary.module.system.service.dept.DeptService;
import cn.qmsk.intermediary.module.system.service.dept.PostService;
import cn.qmsk.intermediary.module.system.service.oauth2.OAuth2TokenService;
import cn.qmsk.intermediary.module.system.service.permission.PermissionService;
import cn.qmsk.intermediary.module.system.service.tenant.TenantService;
...
import static cn.qmsk.intermediary.framework.common.util.collection.SetUtils.asSet;
import static cn.qmsk.intermediary.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.qmsk.intermediary.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.qmsk.intermediary.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.qmsk.intermediary.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.qmsk.intermediary.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.qmsk.intermediary.framework.test.core.util.RandomUtils.*;
import static cn.qmsk.intermediary.module.system.enums.ErrorCodeConstants.*;
import static cn.qmsk.intermediary.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("intermediaryyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("intermediaryyuanma");
        ...
        assertEquals("intermediaryyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("intermediaryyuanma"))).thenReturn("java");
