package cn.qmsk.intermediary.module.system.service.social;
...
import cn.qmsk.intermediary.framework.common.util.cache.CacheUtils;
import cn.qmsk.intermediary.framework.common.util.http.HttpUtils;
import cn.qmsk.intermediary.framework.common.util.object.BeanUtils;
import cn.qmsk.intermediary.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.qmsk.intermediary.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.qmsk.intermediary.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.qmsk.intermediary.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.qmsk.intermediary.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.qmsk.intermediary.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.qmsk.intermediary.module.system.dal.dataobject.social.SocialClientDO;
import cn.qmsk.intermediary.module.system.dal.mysql.social.SocialClientMapper;
import cn.qmsk.intermediary.module.system.dal.redis.RedisKeyConstants;
import cn.qmsk.intermediary.module.system.enums.social.SocialTypeEnum;
import cn.qmsk.intermediary.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.qmsk.intermediary.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.qmsk.intermediary.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${intermediary.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${intermediary.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/intermediary-cloud/pulls/230
